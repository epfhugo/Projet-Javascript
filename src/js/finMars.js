...
export default class finMars extends Phaser.Scene {
  constructor() {
    super({ key: "finMars" }); // mettre le meme nom que le nom de la classe
  }
  ...
  preload() {
    ...
    this.load.image("mars", "src/assets/mars.png");
...
/***********************************************************************/
  ...
  create() {
    ...
    const meilleurScore = parseInt(localStorage.getItem(`meilleurScore_${'mars'}`)) || 0;
    const meilleureVague = parseInt(localStorage.getItem(`meilleureVague_${'mars'}`)) || 0;
    const dernierScore = parseInt(localStorage.getItem(`dernierScore_${'mars'}`)) || 0;
    const derniereVague = parseInt(localStorage.getItem(`derniereVague_${'mars'}`)) || 0;
